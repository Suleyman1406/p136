...
const closeBtn = document.getElementById("hamburger_menu_close_btn");
const openBtn = document.getElementById("hamburger_menu_open_btn");
const hamburgerMenu = document.getElementById("hamburger_menu");

closeBtn.addEventListener("click", () => {
  hamburgerMenu.style.left = "-200px";
});
